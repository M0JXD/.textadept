...
<a id="distraction_free.hide_margins"></a>
## `distraction_free.hide_margins`

Whether to hide the margins (line numbers).

The default value is `false`.

<a id="distraction_free.hide_menubar"></a>
## `distraction_free.hide_menubar`

Whether to hide the menubar.

The default value is `true`.

<a id="distraction_free.hide_statusbar"></a>
## `distraction_free.hide_statusbar`

Whether to hide the statusbar.

The default value is `true`.

<a id="distraction_free.hide_tabs"></a>
## `distraction_free.hide_tabs`

Whether to hide the tabbar.

The default value is `true`.

<a id="distraction_free.hide_term_title"></a>
## `distraction_free.hide_term_title`

Whether to hide the title in the terminal version.

The default value is `true`.

<a id="distraction_free.maximise"></a>
## `distraction_free.maximise`

Whether to maximise the window.

The default value is `false`.

<a id="distraction_free.toggle_shortcut"></a>
## `distraction_free.toggle_shortcut`
