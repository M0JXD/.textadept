...
colors.selection = UI == 'terminal' and 0xe4ddda or (0x40000000 + colors.overlay_2)
colors.lineback = UI == 'terminal' and 0xf6e7e4 or (0x18000000 + colors.lavender)
...
-- Makefile.
styles.target = {fore = colors.mauve}
-- Markdown.
